...
parser.add_argument('-load_path', help='Checkpoint to load path from', default='/home/khtt/code/InfoGAN-PyTorch/output/checkpoint/MNIST/model_epoch_100.pth.tar')
...
idx = np.array([5 for i in range(10)]).repeat(10)
# index = []
# for i in range(10):
#     for j in range(10):
#         index.append(j)
...
z = torch.ones(100, params.num_z, 1, 1, device=device)
